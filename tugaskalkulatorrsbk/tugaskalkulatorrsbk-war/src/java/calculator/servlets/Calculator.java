...
public class Calculator extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>CALCULATOR STATEFULL EJB</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<center><h2>Calculator Statefull</h2></center>");
    ...
    private CalculatorBeanLocal lookupCalculatorBeanLocal() {
        try {
            ...
            return (CalculatorBeanLocal) c.lookup("java:global/tugaskalkulatorrsbk/tugaskalkulatorrsbk-ejb/CalculatorBean!calculator.ejb.CalculatorBeanLocal");
